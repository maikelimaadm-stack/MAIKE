          ...
          <div className="overflow-auto max-h-[500px]">
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50 border-b">
                  {colunasOrdenadas.map((coluna) => {
                    ...
                    if (coluna.id === 'acoes') {
                      return <TableHead key="acoes" className="text-xs text-center w-8 border-r border-slate-200"></TableHead>;
                    }
              ...
              <TableBody>
                {isLoading ? (
                  <TableRow>
                    <TableCell colSpan={20} className="text-center py-12 text-slate-400 text-xs">Carregando...</TableCell>
                  </TableRow>
                ) : pesagensPaginadas.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={20} className="text-center py-12 text-slate-400 text-xs">
                  ...
                  pesagensPaginadas.map((p) => (
                    <TableRow key={p.id} className="hover:bg-slate-50 transition-colors border-b">
                      {colunasOrdenadas.map((coluna) => {
                        ...
                        if (coluna.id === 'acoes') {
                          return (
                            <TableCell key="acoes" className="text-center border-r border-slate-200">
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                        ...
                        if (coluna.id === 'numero_animal') {
                          return <TableCell key={coluna.id} className="font-semibold text-xs border-r border-slate-200">{p.numero_animal}</TableCell>;
                        }
                        if (coluna.id === 'sexo') {
                          return (
                        ...
                        if (coluna.id === 'peso') {
                          return <TableCell key={coluna.id} className="text-right font-mono text-xs font-semibold border-r border-slate-200">{p.peso?.toLocaleString('pt-BR')} kg</TableCell>;
                        }
                        ...
                        if (coluna.id === 'dias') {
                          return <TableCell key={coluna.id} className="text-xs text-right font-mono border-r border-slate-200">{p.dias || '-'}</TableCell>;
                        }
                        if (coluna.id === 'ganho') {
                          return <TableCell key={coluna.id} className="text-right font-mono text-xs text-slate-600 border-r border-slate-200">{p.ganho ? `${p.ganho.toLocaleString('pt-BR')} kg` : '-'}</TableCell>;
                        }
                        if (coluna.id === 'gmd') {
                          return (
                        ...
                        return <TableCell key={coluna.id} className="text-xs border-r border-slate-200">-</TableCell>;
                      })}
                    </TableRow>
                  ))
                )}
