      ...
      <div className={`bg-white print:shadow-none ${orientacao === 'paisagem' ? 'print:landscape' : ''}`}>
        ...
        <div className="print-area p-8 print:p-0">
          ...
          <div className="border-b-2 border-black pb-1 mb-2">
            ...
            <div>
              <h2 className="text-base font-bold">Relatório de Pesagens Individuais {(() => { switch(tipoRelatorio){ case 'analitico': return '(Analítico)'; case 'sintetico': return '(Sintético)'; case 'apartacao': return '(Apartação/Lote)'; case 'apartacao_data': return '(Apartação por Data)'; case 'vendas': return '(Vendas)'; default: return ''; } })()}</h2>
              {(dataInicio || dataFim) && (
