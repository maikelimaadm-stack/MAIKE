      ...
      {!showForm && (
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
          <div>
            ...
            <p className="text-xs text-slate-600">Cadastro e gerenciamento de produtos</p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button variant="outline" size="icon" onClick={() => setShowConfigColunas(true)} className="h-7 w-7"><Settings className="w-4 h-4" /></Button>
            <Button onClick={() => { setEditingProduto(null); setShowForm(true); }} size="sm" className="h-7 text-xs px-3 bg-emerald-600 hover:bg-emerald-700 text-white"><Plus className="w-3.5 h-3.5" /> Adicionar</Button>
          </div>
        </div>
      )}
