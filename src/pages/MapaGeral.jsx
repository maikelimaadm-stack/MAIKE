...
export default function MapaGeral() {
  ...
  const executarRefreshMapa = useCallback(async (showToast = true) => {
    ...
    if (podeUsarTarefasMapa) await refetchTarefas();
    ...
    <div className="fixed inset-0 z-50 bg-white" translate="no">
      <div className="w-full h-full relative">
        ...
        <div className="absolute bottom-2 left-2 right-2 z-10">
          <div className="bg-white/90 pr-1 pl-1 rounded-xl backdrop-blur-sm shadow-lg flex items-center justify-between w-10 y">
