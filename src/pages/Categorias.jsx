...
import { Plus, Edit, Trash2, FolderOpen, Settings, Search, MoreVertical, ArrowUpDown, ArrowUp, ArrowDown, Loader2, GripVertical, ChevronLeft, ChevronRight, X } from "lucide-react";
    ...
    <div className="p-4 md:p-6 space-y-1">
      {!showForm && (
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
          <div>
            <h1 className="text-lg font-bold text-slate-900">Categorias</h1>
            <p className="text-xs text-slate-600">Gerenciar categorias de estoque</p>
          </div>
              ...
              <CardContent className="p-4">
                <form onSubmit={handleSubmit} className="space-y-2">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs uppercase">Subcategoria</Label>
                      <Input
          ...
          <CardHeader className="bg-white border-b border-slate-200 py-2 px-4">
           <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
             <div className="flex items-center gap-3">
               ...
               <span className="text-xs text-slate-500">{filteredCategorias.length} de {categorias.length} registros</span>
             </div>
