...
export default function GruposAtividades() {
  ...
  useEffect(() => { try { const s = localStorage.getItem('grupos_atividades_colunas'); if (s) setColunas(c=>({...c, ...JSON.parse(s)})); } catch {} }, []);
      ...
      <Card>
        <CardContent className="p-3">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <div className="flex gap-2">
              {selected.length > 0 && (
                <Button variant="outline" size="sm" className="h-8 text-xs" onClick={excluirSelecionados}>Excluir Selecionados</Button>
              )}
                        ...
                        <TableCell className="text-xs py-1 border border-gray-300 w-8">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start">
                              ...
                              <DropdownMenuItem className="text-xs text-red-600" onClick={()=>excluir(g.id)}>Excluir</DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                        </TableCell>
                      )}
