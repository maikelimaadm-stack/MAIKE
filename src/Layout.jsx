...
const DEFAULT_MENU = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: "rel-remover-duplicados", title: "Remover Duplicados", url: "RemoverDuplicados" },
    ],
  },
...
export default function Layout({ children, currentPageName }) {
  ...
  const [menuItems, setMenuItems] = useState(() => {
    ...
    const CURRENT_VERSION = '2025-12-22-gestao-tarefas-restored-v1'; // Atualizar esta versão quando adicionar novos menus
