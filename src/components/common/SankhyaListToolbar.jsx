    ...
    <div className="border-[0.5px] border-slate-100 bg-white shadow-none overflow-hidden">
      <div className="flex items-center gap-0 border-b-[0.5px] border-slate-100 overflow-x-auto whitespace-nowrap">
        ...
        <div className="ml-auto flex items-center gap-0">
          <div className="relative h-7 w-44 md:w-56 border-y-0 border-l-[0.5px] border-slate-100 bg-white">
            <input
              value={searchValue}
      ...
      {viewMode === "record" && (
        <div className="mt-1 h-8 flex items-center gap-2 bg-white border-b-[0.5px] border-slate-100 px-2">
