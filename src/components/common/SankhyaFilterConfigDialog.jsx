...
export default function SankhyaFilterConfigDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl rounded-none p-0 gap-0 w-[calc(100vw-16px)] md:w-full">
        ...
        <div className="max-h-[75dvh] md:max-h-[65vh] overflow-auto p-2 space-y-2 text-xs">
          <div className="border border-slate-300 bg-slate-50 p-2 space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_90px] gap-2 md:gap-1">
            ...
            <div className="space-y-1">
              {filterFolders.map((folder, index) => (
                <div key={folder.id} className="grid grid-cols-1 md:grid-cols-[1fr_92px] gap-2 items-center">
          ...
          {orderedFields.map((field) => {
            ...
            return (
              <div key={field.id} className="grid grid-cols-[24px_1fr] md:grid-cols-[24px_1fr_150px_130px_52px] items-center gap-2 border border-slate-200 bg-white px-2 py-2 md:py-1">
