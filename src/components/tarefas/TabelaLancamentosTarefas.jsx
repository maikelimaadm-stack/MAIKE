...
<Card>
  {/* HEADER COM BOTÃO */}
  <div className="flex items-center justify-between px-1 py-0 border-b bg-slate-50">
    ...
    <Button
            variant="ghost"
            size="sm"
            onClick={toggleFiltros} className="inline-flex items-center justify-center gap-1 whitespace-nowrap font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground rounded-md px-1 h-5 text-xs">
