  ...
  return (
    <>
      ...
      <div className="absolute top-3 left-3 z-20 flex gap-1.5">
        ...
        {showTarefasButton &&
        <Button variant="secondary" size="icon" onClick={onOpenTarefas} className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-secondary-foreground absolute top- left-15 z-20 h-7 w-7 rounded-full bg-white/90 backdrop-blur-sm shadow-lg hover:bg-white" title="Tarefas">
