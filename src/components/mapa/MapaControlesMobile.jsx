...
export default function MapaControlesMobile({
  ...
  return (
    <>
      ...
      <div className="bg-slate-700 pt-1 pr-1 pb-1 pl-1 rounded-lg absolute top-0.5 right-1 spacy-1">
        <div className="bg-slate-700 pb-2 rounded-lg flex gap-1 shadow-md">
          <Button
