...
<Badge
            variant="outline" className="text-[10px] mx-1 font-semibold rounded-md min-w-[130px] max-w-[180px] inline-flex items-center border transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent shadow-none !bg-yellow-300 !text-black hover:!bg-yellow-300">
