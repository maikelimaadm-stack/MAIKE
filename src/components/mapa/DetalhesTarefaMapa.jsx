...
<Badge
  ...
  Tarefa: {currentTarefa.titulo}
                ...
                <div className="grid-cols-2 gap-1 p-0 spacy-1">
...
<Badge
            variant="outline" className="inline-flex items-center rounded-md border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground text-[10px] border-transparent shadow-none !bg-blue-300 !text-black hover:!bg-blue-300">
