  ...
  return (
    <div className="fixed inset-0 z-50 bg-white">
      ...
      <div className="w-full h-full relative">
        ...
        {/* Fechar */}
        <Button onClick={() => onOpenChange(false)} variant="secondary" size="icon" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-secondary-foreground absolute top-1 left- z-20 h-12 w-12 rounded-full bg-white/90 backdrop-blur-sm shadow-lg hover:bg-white">
