  ...
  useEffect(() => {
    ...
    if (Array.isArray(initialData.produtos_selecionados) && initialData.produtos_selecionados.length > 0) {
      ...
      itemsSource = [{
        ...
        unidade: initialData.unidade || initialData.unidade_medida || 'UN',
        quantidade: initialData.quantidade,
        // Fallbacks seguros sem alterar regra de negócio
        preco_unitario: (initialData.preco_unitario ?? initialData.valor_unitario),
        total: (initialData.total ?? initialData.valor_total),
        desconto: initialData.desconto ?? 0,
        liquido: (initialData.liquido ?? initialData.valor_total ?? initialData.total),
