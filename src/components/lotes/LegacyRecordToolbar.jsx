...
export default function LegacyRecordToolbar({ title, operationLabel, showSaveActions = false, onCancel, onSettingsClick, onToggleView, total = 0, currentIndex = 0, onNew, onFirst, onPrevious, onNext, onLast, onDelete, onDuplicate, onRefresh }) {
  ...
  return (
    <div className="border-[0.5px] border-slate-50 bg-white shadow-none overflow-hidden">
      <div className="flex items-center gap-0 border-b-[0.5px] border-slate-50 overflow-x-auto whitespace-nowrap">
        ...
        <>
            ...
            <Button type="button" variant="outline" size="sm" onClick={onCancel} className="h-7 px-3 rounded-none border-y-0 border-l-0 border-r-[0.5px] border-slate-50 bg-slate-50 hover:bg-amber-50 text-xs text-slate-700 shadow-none">
