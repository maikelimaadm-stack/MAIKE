...
export default function LegacyRecordToolbar({ title, operationLabel, showSaveActions = false, onCancel, onSettingsClick, onToggleView, total = 0, currentIndex = 0, onNew, onFirst, onPrevious, onNext, onLast, onDelete, onDuplicate, onRefresh }) {
  ...
  return (
    <div className="border border-slate-300 bg-slate-100 shadow-sm overflow-hidden">
      <div className="flex items-center gap-0 h-8 border-b border-slate-300 overflow-x-auto whitespace-nowrap">
      ...
      <div className="h-7 flex items-center gap-2 bg-white border-b border-slate-200 pr-2 pl-2 my-1">
