  ...
  return (
    <div className="bg-white shadow-none overflow-hidden">
      <div className="flex items-center gap-0 overflow-x-auto whitespace-nowrap bg-white border-[0.5px] border-slate-200/60">
        ...
        {showEditAction && <Button type="button" variant="outline" size="icon" onClick={onEdit} disabled={!canNavigate} className={fileButtonClass} title="Editar registro"><Pencil className="w-3.5 h-3.5" /></Button>}
