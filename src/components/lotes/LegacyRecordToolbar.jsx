  ...
  return (
    <div className="border border-slate-300 bg-slate-100 shadow-sm">
      <div className="flex items-center gap-0 border-b border-slate-300 overflow-x-auto whitespace-nowrap">
        ...
        <div className="mx-1 h-10 px-4 inline-flex items-center gap-2 bg-white border-2 border-green-500 shadow-[0_0_0_1px_rgba(34,197,94,0.25)] text-xs font-semibold text-slate-700">
          {statusLabel}
