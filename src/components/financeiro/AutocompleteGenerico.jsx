  ...
  return (
    <div ref={wrapperRef} className={`relative ${className}`}>
      ...
      {open && itensFiltrados.length > 0 && (
        <div className="absolute z-50 w-full mt-1 bg-white border border-slate-200 rounded-md shadow-lg max-h-[60vh] md:max-h-[70vh] overflow-auto">
      ...
      {open && searchTerm && itensFiltrados.length === 0 && (
        <div className="absolute z-50 w-full mt-1 bg-white border border-slate-200 rounded-md shadow-lg max-h-[40vh] overflow-auto">
