  ...
  return (
    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
      <Card className="shadow-sm border-slate-300 bg-white">
        <CardHeader className="flex flex-col space-y-1.5 bg-slate-50 border-b border-slate-200 py-1 px-1">
          <CardTitle className="text-sm font-semibold text-slate-700">
            {isEditing ? 'Editar Lançamento' : `Novo Lançamento - ${tipoLancamento || 'Pagar'}`}
          </CardTitle>
        </CardHeader>
