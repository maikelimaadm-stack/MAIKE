...
| Estado da missão | **entregue e certificada após P0.1-R3** — `npm run verify:all` sai com 0, 12/12 etapas |
...
| Missão | Nome | Estado |
|---|---|---|
| P0 | Product Scope Reset | **entregue e certificada após P0.1-R3** |
