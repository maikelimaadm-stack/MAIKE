...
5. Ler o relatório da última missão concluída em `docs/engineering/`

**Só depois disso começar a trabalhar.**

## Fim de sessão

1. Escrever ou atualizar o relatório da missão em `docs/engineering/`
2. Atualizar `docs/engineering/CURRENT-STATE.md`
3. Registrar decisões novas em `docs/engineering/DECISIONS.md`
